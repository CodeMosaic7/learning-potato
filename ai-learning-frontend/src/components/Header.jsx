...
const Header = () => {
  ...
  return (
    <nav className="relative z-10 container mx-auto px-6 py-4 font-sans font-bold">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <span className="text-2xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent font-sans" onClick={gotohome}>
            mello.ai
          </span>
        </div>
