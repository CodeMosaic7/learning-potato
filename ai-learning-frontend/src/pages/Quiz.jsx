...
const Quiz = () => {
  ...
  const startQuiz = async () => {
    ...
    try {
      ...
      const questions = transformQuestions(mockQuestions.slice(0, quizSettings.questionCount));
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-black to-slate-900 overflow-hidden py-8">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-300 text-lg">Test your knowledge with our intelligent quiz system</p>
        </div>

        <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 backdrop-blur-sm border border-purple-500/30 rounded-3xl p-8 hover:border-purple-400/50 transition-all">
          {/* Quiz Setup Screen */}
          {!quizState.isActive && !quizState.isComplete && (
            <div className="text-center">
              <div className="relative mb-8">
                <Trophy className="w-24 h-24 text-yellow-400 mx-auto mb-6" />
                <div className="absolute -top-2 -right-2 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full p-2">
                  <Star className="w-6 h-6 text-white" />
                </div>
              </div>
              
              <h2 className="text-3xl font-bold text-white mb-4">Ready for Your Quiz Challenge?</h2>
              <p className="text-slate-300 mb-8 text-lg">Customize your learning experience</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  ...
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                    ...
                    <select
                      ...
                      className="w-full bg-slate-800/50 border border-slate-700 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all"
                    >
              ...
              {/* Error Display */}
              {quizState.error && (
                <div className="mb-6 p-4 bg-red-500/20 backdrop-blur-sm border border-red-400/50 rounded-xl text-red-200 flex items-center">
            ...
            <div className="text-center py-12">
              {quizState.isLoading ? (
                <div>
                  ...
                  <p className="text-slate-300">Finding the perfect questions for you...</p>
                </div>
              ) : quizState.error ? (
                <div>
                  <X className="w-16 h-16 text-red-400 mx-auto mb-6" />
                  <h3 className="text-2xl font-bold text-red-400 mb-4">Something went wrong</h3>
                  <p className="text-red-300 mb-6">{quizState.error}</p>
                  <button
                    onClick={resetQuiz}
                    className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-3 rounded-full font-medium hover:from-purple-500 hover:to-pink-500 transition-all duration-300"
                  >
                ...
                <div>
                  ...
                  <p className="text-slate-300 mb-6">Please try different settings</p>
                  <button
                    onClick={resetQuiz}
                    className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-3 rounded-full font-medium hover:from-purple-500 hover:to-pink-500 transition-all duration-300"
                  >
          ...
          {quizState.isActive && !quizState.isComplete && quizQuestions.length > 0 && (
            <div>
              ...
              <div className="flex justify-between items-center mb-8 flex-wrap gap-4">
                ...
                <div className="flex items-center bg-red-500/20 backdrop-blur-sm text-red-300 px-4 py-2 rounded-full border border-red-400/50">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 mb-8">
                    ...
                    return (
                      <button
                        ...
                        className={`p-5 rounded-xl text-left transition-all duration-300 transform hover:scale-[1.02] ${
                          showResult
                            ? isCorrect
                              ? 'bg-green-500/20 border-2 border-green-500 text-green-300 shadow-lg'
                              : isSelected
                              ? 'bg-red-500/20 border-2 border-red-500 text-red-300 shadow-lg'
                              : 'bg-white/5 border border-white/10 text-slate-400'
                            : 'bg-white/5 border border-white/20 text-white hover:bg-white/10 hover:border-purple-500 cursor-pointer hover:shadow-md'
                        }`}
                      >
                ...
                {userAnswer && currentQuestion.explanation && (
                  <div className="mt-8 p-6 bg-blue-500/20 backdrop-blur-sm rounded-xl border border-blue-400/50">
          ...
          {quizState.isComplete && (
            <div className="text-center py-8">
              <div className="relative mb-8">
                ...
                <div className="absolute -top-4 -right-4 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full p-3">
              ...
              {/* Score Card */}
              <div className="max-w-md mx-auto mb-8 bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-sm rounded-2xl p-8 border-2 border-purple-500/50">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-3 border border-white/10">
                    <div className="text-slate-400">Time Used</div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button
                  onClick={resetQuiz}
                  className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-4 rounded-full font-bold text-lg hover:from-purple-500 hover:to-pink-500 transition-all duration-300 shadow-lg transform hover:scale-105 flex items-center justify-center"
                >
                ...
                <button
                  ...
                  className="bg-white/10 backdrop-blur-sm border-2 border-white/20 text-white px-8 py-4 rounded-full font-medium hover:bg-white/20 transition-all duration-300 flex items-center justify-center"
                >
